    ...
    <header className={styles.header}>
      ...
      <div className={styles.right}>
        <div className={styles.socials}>
          ...
          {/* Max */}
          <a href="https://max.ru/id381016235739_biz" className={`${styles.socialIcon} ${styles.socialIconMax}`} aria-label="Max">
            <img 
